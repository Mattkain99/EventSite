        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_Reveller_UserId",
                        column: x => x.UserId,
                        principalSchema: "EventSite",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_Reveller_UserId",
                        column: x => x.UserId,
                        principalSchema: "EventSite",
                        principalTable: "Reveller",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_Reveller_UserId",
                        column: x => x.UserId,
                        principalSchema: "EventSite",
                        principalTable: "Reveller",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserTokens_Reveller_UserId",
                        column: x => x.UserId,
                        principalSchema: "EventSite",
                        principalTable: "Reveller",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RevellerId = table.Column<string>(type: "text", nullable: false),
